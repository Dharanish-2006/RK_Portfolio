    ...
    <>
      <nav style={{
          ...
          <div style={{
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M2 12h20M12 2a15 15 0 0 1 4 10 15 15 0 0 1-4 10 15 15 0 0 1-4-10 15 15 0 0 1 4-10z"
                stroke="rgba(233,193,118,0.85)" strokeWidth="1.5" fill="none"/>
            </svg>
          </div>
          <span style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 800, fontSize: 14, color: 'var(--navy)', letterSpacing: '0.06em' }}>
            RK EXPORTS
          </span>
        </a>
        ...
        <div style={{ display: 'flex', gap: 2, alignItems: 'center' }} className="nav-desktop">
          {links.map(l => (
            ...
            onMouseEnter={e => { e.target.style.background = isDark ? 'rgba(77,154,255,0.12)' : 'rgba(0,89,187,0.08)'; e.target.style.color = 'var(--blue)' }}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          onMouseEnter={e => { e.currentTarget.style.background = 'var(--blue)'; e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(0,89,187,0.3)'; e.currentTarget.style.color = '#fff' }}
          onMouseLeave={e => { e.currentTarget.style.background = 'var(--navy)'; e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.color = isDark ? '#0d1420' : '#fff' }}
          className="nav-cta">
            Get a Quote
          </button>
      ...
      <div style={{
        ...
        {links.map((l, i) => (
          <button key={l} onClick={() => scrollTo(l)} style={{
            background: 'none', border: 'none', cursor: 'pointer',
            fontFamily: 'Montserrat,sans-serif', fontSize: 'clamp(24px,8vw,36px)', fontWeight: 700,
        ...
        <div style={{
          ...
          opacity: mobileOpen ? 1 : 0,
          transform: mobileOpen ? 'translateY(0)' : 'translateY(20px)',
          transition: `all 0.5s cubic-bezier(0.32,0.72,0,1) ${links.length * 0.07 + 0.05}s`,
        }}>
